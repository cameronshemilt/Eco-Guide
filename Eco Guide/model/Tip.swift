    ...
    var data: [Tip] {
        return [
            ...
            Tip(id: 3, title: "Change to an electric car",
                ...
                category: .transport,
                callback: { return (EcoCalculator.carEmission(km: self.driving.number, isElectric: false) * -0.6 * 365) }),
            ...
            Tip(id: 12, title: "Turn off heating in summer",
                ...
                category: .housing,
                callback: { return (EcoCalculator.heating(people: self.household.numOfPeople, renewable: false) * -0.5) }),
